...
namespace Algebra
{
    public struct Matrix
    {
        ...
        /// <summary>
        /// Determines whether a <see cref="Matrix"/> is considered equal to another
        /// </summary>
        /// <param name="obj">The other <see cref="Matrix"/></param>
        ...
        /// Note : A and B has to be of the same dimensions
        /// </summary>
        /// <param name="a">a number representing the Identity <see cref="Matrix"/></param>
        /// <param name="B"><see cref="Matrix"/> B</param>
        /// <returns>a <see cref="Matrix"/> of same dimension than A nad B</returns>
        public static Matrix operator +(float a, Matrix B)
        {
